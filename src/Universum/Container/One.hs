...
import Universum.Base (Char, Int, Word8)
import Universum.Container.Reexport (HashMap, HashSet, Hashable, IntMap, IntSet, Map, Set, uncurry)
...
-- $setup
-- >>> import Universum.Base (Int, String)
